      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_1fr] gap-12 items-center">
        <div>
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-6xl md:text-7xl font-sans font-extrabold tracking-tight leading-[1.02]"
          >
            {profile.name}.<br />
            <span className="text-muted">I build things.</span>
          </motion.h1>
          ...
          >
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="font-mono text-sm px-6 py-3 rounded-full bg-accent text-bg font-semibold hover:scale-[1.03] active:scale-[0.98] transition-transform focus-ring"
            >
              Resume
            </a>
            <button
        ...
        <motion.button
          ...
          className="text-left w-full rounded-xl border border-border bg-panel overflow-hidden shadow-2xl font-mono text-xs md:text-sm hover:border-accent/50 transition-colors focus-ring"
        >
          <div className="flex items-center gap-2 px-4 py-2.5 bg-[#151318] border-b border-border">
